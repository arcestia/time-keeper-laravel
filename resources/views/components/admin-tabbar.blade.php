<div class="border-b mb-4">
    <div class="flex gap-2">
        ...
        <button id="tabbtn-tokens" class="px-3 py-2 text-sm font-medium text-gray-600 hover:text-gray-800">Tokens</button>
        <button id="tabbtn-guilds" class="px-3 py-2 text-sm font-medium text-gray-600 hover:text-gray-800">Guilds</button>
