<div id="tab-stats">
    <div class="flex items-end gap-3">
        <div class="flex-1">
            ...
            <input id="adm-q" type="text" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="e.g. alice">
        </div>
